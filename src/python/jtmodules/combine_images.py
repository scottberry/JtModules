...
def combine_images(image01, image02, multiplication_factor01=1,
    ...
    Note
    ----
    Images will be clipped at different values for visualization.
    '''
    #Error types
    ...
    if plot:
        ...
        plots = [
            plotting.create_intensity_image_plot(image01, 'ul', clip=True),
            plotting.create_intensity_image_plot(image02, 'ur', clip=True),
